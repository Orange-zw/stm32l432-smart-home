...
//#define RST_PIN      GPIO_Pin_0      // 复位引脚
//#define MISO_PORT    GPIOA
//#define MISO_PIN     GPIO_Pin_7     // 主入从出引脚，数据接收引脚
//#define MOSI_PORT    GPIOA
//#define MOSI_PIN     GPIO_Pin_6     // 主出从入引脚，数据发送引脚
//#define SCK_PORT     GPIOA
//#define SCK_PIN      GPIO_Pin_5      // 时钟引脚
//#define SDA_PORT     GPIOA
//#define SDA_PIN      GPIO_Pin_4      // 片选引脚

// 引脚定义
#define RST_PORT     GPIOA
#define RST_PIN      GPIO_Pin_9      // 复位引脚
#define MISO_PORT    GPIOB
#define MISO_PIN     GPIO_Pin_15     // 主入从出引脚，数据接收引脚
#define MOSI_PORT    GPIOB
#define MOSI_PIN     GPIO_Pin_14     // 主出从入引脚，数据发送引脚
#define SCK_PORT     GPIOB
#define SCK_PIN      GPIO_Pin_13      // 时钟引脚
#define SDA_PORT     GPIOB
#define SDA_PIN      GPIO_Pin_12      // 片选引脚
