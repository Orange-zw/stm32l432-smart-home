...
void TCS34725_I2C_Init()
{
	...
	RCC_APB2PeriphClockCmd(TCS_SCL_GPIO_CLOCK | TCS_SDA_GPIO_CLOCK, ENABLE); // 使能PORTG口时钟

	GPIO_InitStructure.GPIO_Pin = TCS_SCL_GPIO_PIN;	   // PB10/PB10=外接I2C
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   // 通用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;  // 速度
	GPIO_Init(TCS_SCL_GPIO_WHAT, &GPIO_InitStructure); // 对选中管脚初始化
	GPIO_SetBits(TCS_SCL_GPIO_WHAT, TCS_SCL_GPIO_PIN); // 高电平

	GPIO_InitStructure.GPIO_Pin = TCS_SDA_GPIO_PIN;	   // PB10/PB10=外接I2C
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   // 通用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;  // 速度
	GPIO_Init(TCS_SDA_GPIO_WHAT, &GPIO_InitStructure); // 对选中管脚初始化
	GPIO_SetBits(TCS_SDA_GPIO_WHAT, TCS_SDA_GPIO_PIN); // 高电平
}
/*********************************************/
